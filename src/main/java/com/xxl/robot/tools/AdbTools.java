...
public class AdbTools {
   ...
   public static String down(){
     ...
     * todo 向下滑动，正常操作
     */
    public static String downLarge(){
        int x = 100 + RandomTools.init(300);
        int y = 1200 + RandomTools.init(600);
        int x1 = 1200 + RandomTools.init(600);
        int y1 = 100 + RandomTools.init(300);
        String downDraw = "adb shell input swipe "+ x + " " + y + " " + x1 +" " +y1;
     ...
     * todo 向上滑动，返回操作
     */
    public static String upLarge(){
        int x = 1200 + RandomTools.init(600);
        int y = 100 + RandomTools.init(300);
        int x1 = 100 + RandomTools.init(300);
        int y1 = 1200 + RandomTools.init(600);
        String downDraw = "adb shell input swipe "+ x + " " + y + " " + x1 +" " +y1;
