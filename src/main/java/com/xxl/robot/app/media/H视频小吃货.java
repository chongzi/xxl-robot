...
public class H视频小吃货 {
    ...
    public static void handle1(Robot robot,String robotCode, String appCode, String event,List<PhoneCodeDto> phoneCodeDtos){
        ...
        try {
            ...
            PhoneCodeDto dto43 = phoneCodeDtos.stream().filter(o -> o.getAppEvent().equals("category来赚钱-签到-看广告")).findAny().orElse(null);
    ...
    public static void handle7(Robot robot,String robotCode, String appCode, String event,List<PhoneCodeDto> phoneCodeDtos){
        ...
        try {
            ...
            PhoneCodeDto dto44 = phoneCodeDtos.stream().filter(o -> o.getAppEvent().equals("category来赚钱-拆红包-零金币1")).findAny().orElse(null);
            String operate44 = AdbTools.tap(dto44.getPositionX(), dto44.getPositionY());
            MouseTools.normalEvent(robot, operate44);
            MouseTools.normalEvent(robot, operateBackHome);

            PhoneCodeDto dto45 = phoneCodeDtos.stream().filter(o -> o.getAppEvent().equals("category来赚钱-拆红包-零金币2")).findAny().orElse(null);
            String operate45 = AdbTools.tap(dto45.getPositionX(), dto45.getPositionY());
            MouseTools.normalEvent(robot, operate45);
            MouseTools.normalEvent(robot, operateBackHome);

            PhoneCodeDto dto46 = phoneCodeDtos.stream().filter(o -> o.getAppEvent().equals("category来赚钱-拆红包-零金币3")).findAny().orElse(null);
            String operate46 = AdbTools.tap(dto46.getPositionX(), dto46.getPositionY());
            MouseTools.normalEvent(robot, operate46);
            MouseTools.normalEvent(robot, operateBackHome);

            PhoneCodeDto dto47 = phoneCodeDtos.stream().filter(o -> o.getAppEvent().equals("category来赚钱-拆红包-零金币4")).findAny().orElse(null);
            String operate47 = AdbTools.tap(dto47.getPositionX(), dto47.getPositionY());
            MouseTools.normalEvent(robot, operate47);
            MouseTools.normalEvent(robot, operateBackHome);

            PhoneCodeDto dto48 = phoneCodeDtos.stream().filter(o -> o.getAppEvent().equals("category来赚钱-拆红包-零金币5")).findAny().orElse(null);
            String operate48 = AdbTools.tap(dto48.getPositionX(), dto48.getPositionY());
            MouseTools.normalEvent(robot, operate48);
            MouseTools.normalEvent(robot, operateBackHome);

            PhoneCodeDto dto49 = phoneCodeDtos.stream().filter(o -> o.getAppEvent().equals("category来赚钱-拆红包-零金币6")).findAny().orElse(null);
            String operate49 = AdbTools.tap(dto49.getPositionX(), dto49.getPositionY());
            MouseTools.normalEvent(robot, operate49);
            MouseTools.normalEvent(robot, operateBackHome);

            PhoneCodeDto dto410 = phoneCodeDtos.stream().filter(o -> o.getAppEvent().equals("category来赚钱-拆红包-零金币7")).findAny().orElse(null);
            String operate410 = AdbTools.tap(dto410.getPositionX(), dto410.getPositionY());
            MouseTools.normalEvent(robot, operate410);
            MouseTools.normalEvent(robot, operateBackHome);

            PhoneCodeDto dto411 = phoneCodeDtos.stream().filter(o -> o.getAppEvent().equals("category来赚钱-拆红包-零金币8")).findAny().orElse(null);
