 ...
 */
public class B浏览器晴象 {
    private static Logger log = LoggerFactory.getLogger(B浏览器晴象.class);
    ...
    List<AppDto> apps = new ArrayList<>();
        switch (event){
            ...
            case AppConstants.GIFT_MONEY://领红包
                ...
                handle81(robot, robotCode, appCode, event, phoneCodeDtos, apps);
                handle82(robot, robotCode, appCode, event, phoneCodeDtos, apps);
                break;
            case AppConstants.TREASURE://开宝箱
                handle9(robot, robotCode, appCode, event, phoneCodeDtos, apps);
                handle101(robot, robotCode, appCode, event, phoneCodeDtos, apps);
                break;
            ...
            case AppConstants.SCRATCH_CARD://刮奖
                ...
                break;
            case AppConstants.OTHER_QINGXIANG_WATCH_VIDEOS://刮奖
                handle21(robot, robotCode, appCode, event, phoneCodeDtos, apps);
                break;
     ...
     * @param phoneCodeDtos
     */
    public static void handle101(Robot robot,String robotCode, String appCode, String event,List<PhoneCodeDto> phoneCodeDtos,List<AppDto> apps){
        AppDto app = new AppDto();
     ...
     * @param phoneCodeDtos
     */
    public static void handle61(Robot robot,String robotCode, String appCode, String event,List<PhoneCodeDto> phoneCodeDtos,List<AppDto> apps){
     ...
     * @param phoneCodeDtos
     */
    public static void handle81(Robot robot,String robotCode, String appCode, String event,List<PhoneCodeDto> phoneCodeDtos,List<AppDto> apps){
        AppDto app = new AppDto();
        app.setCategory("category浏览器");
     ...
     * @param phoneCodeDtos
     */
    public static void handle82(Robot robot,String robotCode, String appCode, String event,List<PhoneCodeDto> phoneCodeDtos,List<AppDto> apps){
        AppDto app = new AppDto();
        app.setCategory("category浏览器");
    ...
    public static void handle19(Robot robot,String robotCode, String appCode, String event,List<PhoneCodeDto> phoneCodeDtos,List<AppDto> apps){
        for(int i=0;i<2;i++) {
            ...
            app.setEventAdvertStep("category刮刮卡-刮卡-advertstep");
     ...
     * @param phoneCodeDtos
     */
    public static void handle21(Robot robot,String robotCode, String appCode, String event,List<PhoneCodeDto> phoneCodeDtos,List<AppDto> apps){
        AppDto app = new AppDto();
